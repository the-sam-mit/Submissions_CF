...
int main(){
	...
	rep(i,0,n-1){
		...
		auto it=sz(mxx)-(lower_bound(mxx.begin(), mxx.end(), mn+1)-mxx.begin());
		// cout<<mn<<" "<<it<<endl;
		cnt += it;
	}
	rep(i,0,n-1){
