...
1271 C - Shawarma Tent.cpp GNU C++14 Accepted
...
c1         c2
	  c4  */
int main(){
	ll n,x,y,c1=0,c2=0,c3=0,c4=0,c12=0,c23=0,c34=0,c41=0;
	cin>>n>>x>>y;
	rep(i,1,n){
		ll tx,ty;
		cin>>tx>>ty;
	...
	ll ans=max(c1+c2+c12,max(c2+c3+c23,max(c34+c3+c4,c41+c4+c1)));
	cout<<ans<<endl;
	if(c1+c2+c12==ans) cout<<x<<" "<<y+1<<endl;
	else if(c2+c3+c23==ans) cout<<x-1<<" "<<y<<endl;
	else if(c3+c4+c34==ans) cout<<x<<" "<<y-1<<endl;
	else if(c4+c1+c41==ans) cout<<x+1<<" "<<y<<endl;
}